...
* Create an artifact configuration for signing containers with [Notation](/artifact-configuration/reference#notation-sign) or [Cosign](/artifact-configuration/reference#cosign-sign) respectively.
